      ...
      <div className="flex flex-col gap-3">
        ...
        <Popover open={startOpen} onOpenChange={setStartOpen}>
          <PopoverTrigger asChild>
            ...
            >
              {startDate ? finnishDateFormatter.format(startDateValue) : "Select date"}
              <ChevronDownIcon />
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-auto overflow-hidden p-0" align="start">
            <Calendar
              ...
              defaultMonth={startDateValue ? startDateValue : new Date(2020, 11, 31)}
            />
          </PopoverContent>
        </Popover>
      </div>
        ...
        <Popover open={endOpen} onOpenChange={setEndOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              className="w-48 justify-between font-normal"
            >
              {endDate ? finnishDateFormatter.format(endDateValue) : "Select date"}
              <ChevronDownIcon />
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-auto overflow-hidden p-0" align="start">
            <Calendar
              ...
              weekStartsOn={1}
              showOutsideDays={false}
              defaultMonth={endDateValue ? endDateValue : new Date(2024, 9, 1)}
            />
          </PopoverContent>
        </Popover>
      </div>
